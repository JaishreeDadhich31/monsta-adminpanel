...
export default function ViewColor() {
  ...
  useEffect(() => {
    axios.post(`${import.meta.env.VITE_API_BASE_URL}/color/view`, {
  ...
  const selectAllCheckBox = () => {
    if (color.length == selectedRecord.length) {
      setSelectedRecord([]);
    }
    else {
      setSelectedRecord([]);
  ...
  const changeStatus = () => {
    ...
    if (selectedRecord.length > 0) {
      ...
      axios.put('http://localhost:5000/api/admin/color/change-status', {
        ids: selectedRecord
        ...
        buttons: [
          ...
          [
            ...
            function (instance, toast) {
              ...
              axios.put('http://localhost:5000/api/admin/color/delete', {
                ids: selectedRecord
      ...
      <div className="min-h-screen bg-gray-50 ml-64">
        ...
        <div className="bg-white border-b px-6 py-4">
          ...
          <p className="text-2xl font-semibold text-gray-800">
            Home | Color |{" "}
            <span className="text-violet-500">View Color</span>
          </p>
                  ...
                  <tr>
                    ...
                    <th className="px-2 w-[100px] py-3">
                      ...
                      <input
                        ...
                        id="purple-checkbox"
                        type="checkbox"
                        checked = {color.length == selectedRecord.length ? 'checked' : ''}
